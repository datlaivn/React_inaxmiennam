...
export default function AiChatAssistantMobile({ isOnProductPage = false }) {
  ...
  return (
    <>
      {showWelcomeToast && (
        <div className="cb-toast cb-toast--in cb-toast--welcome cb-toast--mobile" style={fabStyle}>
          <button
            type="button"
            className="cb-toast__dismiss"
          ...
          >
            <span className="cb-toast__card">
              ...
              <span className="cb-toast__msg">Xem nhanh số điện thoại và Zalo để được hỗ trợ ngay.</span>
            </span>
          </button>
        </div>
      )}
      ...
      {!isOpen && (
        <button
          className={`cb-fab cb-fab--mobile${showGlow ? ' cb-fab--glow' : ''}`}
          onClick={() => { dismissWelcomeToast(); setIsOpen(true) }}
      ...
      {isOpen && (
        <div className="cb-window cb-window--mobile" style={windowStyle}>
                  ...
                  {contactUi.hasZalo && (
                    <a className="cb-contact-card cb-contact-card--zalo" href={contactUi.zaloHref} target="_blank" rel="noopener noreferrer">
                      ...
                      <span className="cb-contact-card__body">
                        ...
                        <span className="cb-contact-card__zalo-btn">Mở Zalo</span>
                      </span>
                    </a>
                  )}
                </div>
